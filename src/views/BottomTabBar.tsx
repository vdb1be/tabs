...
type Props = TabBarOptions & {
  ...
  getAccessibilityRole: (props: { route: Route }) => string;
  getAccessibilityStates: (props: { route: Route }) => string[];
  getButtonComponent: (props: { route: Route }) => React.ComponentType<any>;
  getLabelText: (props: {
    route: Route;
  }) =>
    | ((scene: {
